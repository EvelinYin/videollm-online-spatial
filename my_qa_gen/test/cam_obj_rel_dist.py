...
def process_dataset_parallel(dataset, question_type_list: list, output_path: str, num_workers: int = 4):
    """
    Process camera_obj_rel_dist questions in parallel and save to JSON.
    """
...
if __name__ == "__main__":
    ...
    question_type = ['camera_obj_rel_dist_v1', 'camera_obj_rel_dist_v2', 'camera_obj_rel_dist_v3']

    output_file = "./datasets/vsi-bench/my_qa/test/camera_obj_rel_dist_reformatted.json"
