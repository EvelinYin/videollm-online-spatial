...
if __name__ == "__main__":
    ...
    # breakpoint()
    # unique_data_sources = ds.unique('data_source')
    # print("Unique data sources:", unique_data_sources)

    # unique_question_types = ds.unique('question_type')
    # print("Unique question types:", unique_question_types)
    # question_types = ['object_abs_distance', 'camera_displacement', 'camera_movement_direction',
    #                   'camera_obj_abs_dist', 'camera_obj_rel_dist_v1', 'camera_obj_rel_dist_v2',
    #                   'camera_obj_rel_dist_v3', 'obj_obj_relative_pos_lr', 'obj_obj_relative_pos_nf',
    ...
    output_file = "./datasets/vlm3r_ours/my_qa/train/camera_displacement_reformatted.json"
