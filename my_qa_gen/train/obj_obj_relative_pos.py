...
def process_qa(item: Dict[str, Any], seed: int = None) -> List[Dict[str, Any]]:
    ...
    if not conversations or len(conversations) < 2:
        print("no conversation or conversations < 2")
        return None
...
def process_dataset_parallel(dataset, question_type_list: list, output_path: str, num_workers: int = 4, seed: int = None):
    """
...
if __name__ == "__main__":
    ...
    # Process and save
    output_file = "./datasets/vlm3r_ours/my_qa/train/obj_obj_relative_pos_reformatted.json"
